      ...
      <>
        ...
        <section className="py-20 text-center bg-gradient-to-b from-teal-50 to-sky-100 dark:from-darkBg/60 dark:to-darkCard/40">
          <motion.h2
            ...
            className="text-2xl md:text-3xl font-serif mb-2 text-teal-700 dark:text-indigo-200"
          >
            Featured Galleries
          </motion.h2>
        ...
        <section className="py-24 bg-gradient-to-b from-teal-50 to-sky-100 dark:from-darkCard/50 dark:to-darkCard/30">
          <motion.h2
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="text-2xl md:text-3xl font-serif text-center mb-12 text-teal-700 dark:text-indigo-200"
          >
        ...
        >
          <div className="bg-black/30 h-full flex items-center justify-center px-6">
            <motion.h2
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="text-white text-2xl md:text-4xl font-serif text-center drop-shadow-xl"
            >
        ...
        <section className="py-20 text-center bg-gradient-to-b from-teal-50 to-sky-100 dark:from-darkCard/50 dark:to-darkCard/30">
          <motion.h2
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="text-2xl md:text-3xl font-serif text-teal-700 dark:text-indigo-200"
          >
            Client Love
          </motion.h2>
          ...
          <motion.p
            ...
            viewport={{ once: true }}
            transition={{ delay: 0.2 }}
            className="mt-6 italic max-w-xl mx-auto text-gray-700 dark:text-gray-300"
          >
