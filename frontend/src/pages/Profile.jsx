    ...
    <>
      ...
      ">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-serif mb-6 text-teal-700 dark:text-indigo-200">
            Who I Am
          </h2>
...
function Philosophy({ title, text }) {
  return (
    <div>
      <h3 className="text-lg md:text-xl font-serif mb-3 text-teal-700 dark:text-indigo-200">
        {title}
      </h3>
...
function Stat({ title }) {
  return (
    <div>
      <h3 className="text-2xl md:text-3xl font-serif text-teal-700 dark:text-indigo-200">
        {title}
      </h3>
    </div>
  )
